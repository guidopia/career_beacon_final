...
import { getSavedPersonalityTest } from '../services/independentTests';
import { Download, Home, Brain, Calendar, TrendingUp, ArrowRight } from 'lucide-react';

const SavedPersonalityTest = () => {
    ...
    const loadSavedTest = () => {
        setLoading(true);
        try {
            const savedData = getSavedPersonalityTest();
            if (savedData) {
                setTestData(savedData);
            } else {
                setError('No saved personality test found. Please complete the personality test first.');
            }
        } catch (err) {
    ...
    const formatContentText = (content) => {
        ...
        return paragraphs.map((paragraph, index) => {
            ...
            if (careerMatch) {
                ...
                return (
                    <div key={index} className="mb-4 p-4 bg-gray-50 rounded-lg border-l-3 border-l-emerald-500">
            ...
            if (/^[-•*]\s/.test(trimmedParagraph)) {
                ...
                if (bulletMatch) {
                    ...
                    return (
                        <div key={index} className="mb-3 pl-4 border-l-2 border-l-emerald-500">
                    ...
                    return (
                        <div key={index} className="mb-2 pl-4 border-l-2 border-l-emerald-500">
        ...
        return (
            <div className="space-y-6">
                {sections.map((section, index) => {
                            ...
                            return (
                                <div key={index} className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 p-8">
                                    <div className="flex items-start">
                                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 text-white font-bold text-lg mr-6 shadow-sm flex-shrink-0">
                                            {number}
                                        </div>
                                        <div className="flex-1">
                                            <h3 className="text-xl font-bold text-gray-800 leading-tight mb-2">{title}</h3>
                                            <div className="w-16 h-1 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full mb-4"></div>
                    ...
                    for (let expectedTitle of personalitySections) {
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4">
                <div className="text-center">
                    ...
                    <h2 className="text-xl sm:text-2xl font-semibold text-gray-700 mb-2">Loading Your Personality Profile</h2>
                    ...
                    <div className="bg-white rounded-lg p-8 shadow-sm border max-w-md mx-auto">
                        ...
                        <p className="text-gray-600">Loading your personality data...</p>
                    </div>
                </div>
            </div>
        );
                        ...
                        <div className="bg-white border border-red-100 text-red-600 p-8 rounded-lg shadow-xl max-w-lg mx-auto">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 sm:justify-center">
                                <button
                                    ...
                                    className="bg-emerald-600 text-white px-4 sm:px-6 py-2 rounded-md hover:bg-emerald-700 transition text-sm sm:text-base"
                                >
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
                {/* Header */}
                <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-xl p-6 sm:p-8 mb-6 sm:mb-8 text-white">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                        <div className="flex flex-col sm:flex-row sm:items-center">
                            ...
                            <div>
                                <h1 className="text-2xl sm:text-3xl font-bold mb-2">Your Saved Personality Profile</h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            ...
                            <button
                                onClick={() => navigate('/')}
                                className="bg-white text-emerald-700 px-3 sm:px-4 py-2 rounded-md hover:bg-emerald-50 transition flex items-center justify-center text-sm sm:text-base"
                            >
                ...
                {testData && testData.scores && (
                    <div className="bg-white rounded-xl p-4 sm:p-6 mb-6 sm:mb-8 border shadow-sm">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 sm:gap-4">
                            {Object.entries(testData.scores).map(([trait, score]) => (
                ...
                <div className="bg-white rounded-xl p-4 sm:p-8 shadow-sm border">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-2 sm:space-y-0">
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-800 flex items-center">
                            <Brain className="h-5 w-5 sm:h-6 sm:w-6 text-emerald-600 mr-3" />
                ...
                <div className="text-center mt-6 sm:mt-8">
                    <p className="text-gray-500 text-xs sm:text-sm px-4">
                        This personality analysis is based on the Big 5 model and is intended as guidance for personal development.
                    </p>
                </div>
            </div>
        </div>
...
export default SavedPersonalityTest;
